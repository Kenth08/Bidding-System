...
export function normalizeSupplier(supplier = {}) {
  ...
  return {
    ...
    business_permit_document: supplier.business_permit_document || "",
    business_permit_document_name: supplier.business_permit_document_name || (supplier.business_permit_document ? String(supplier.business_permit_document).split("/").pop() : ""),
    business_permit_document_url: supplier.business_permit_document_url || supplier.business_permit_document || "",
    docs: supplier.docs || [],
    isVerified,
